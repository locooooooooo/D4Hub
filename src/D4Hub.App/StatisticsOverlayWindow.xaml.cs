...
public partial class StatisticsOverlayWindow : Window
{
    ...
    public StatisticsOverlayWindow()
    {
        InitializeComponent();
    }

    public StatisticsOverlayWindow(HudViewModel viewModel)
        : this()
    {
    ...
    public OverlayCaptureAffinityReceipt CaptureAffinityReceipt { get; private set; }

    public void UpdatePlacement(StatisticsHudPlacement placement)
    {
        if (!IsVisible)
        {
            Show();
    ...
    private void Window_SourceInitialized(object? sender, EventArgs e)
    {
        ...
        CaptureAffinityReceipt = OverlayCapturePolicy.ExcludeFromCapture(_handle);
